 ...
 * Generated at: 2018-03-02 09:27:48 UTC
...
public final class resourceList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/common/head.jsp", Long.valueOf(1516501887843L));
    ...
    _jspx_dependants.put("/common/foot.jsp", Long.valueOf(1516501887843L));
  }
...
return;
    ...
    try {
      ...
      out.write("<link rel=\"stylesheet\" href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${staticPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/static/plugin/treegrid/css/jquery.treegrid.css\">\r\n");
      out.write("    <style type=\"text/css\">\r\n");
      out.write("     .ace-nav{\r\n");
      out.write("            height: 45px!important;\r\n");
      out.write("        }\r\n");
      ...
      out.write("                    </li>\r\n");
      out.write("                    <li class=\"active\">资源管理</li>\r\n");
      ...
      out.write("                    \t</div>\r\n");
      out.write("                    \t       <table class=\"table tree-2 table-bordered table-striped table-condensed\" id=\"info\">\r\n");
      out.write("                            <thead>\r\n");
      out.write("                              <tr>\r\n");
      out.write("                                  <th>名称</th>\r\n");
      out.write("                                  <th class=\"hidden-480\">url</th>\r\n");
      out.write("                                  <th class=\"hidden-480\">描述</th>\r\n");
      out.write("                                  <th class=\"hidden-480\">图标</th>\r\n");
      out.write("                                  <th class=\"hidden-480\">状态</th>\r\n");
      out.write("                                  <th class=\"hidden-480\">类型</th>\r\n");
      out.write("                                  <th class=\"hidden-480\">顺序</th>\r\n");
      out.write("                              </tr>\r\n");
      out.write("                            </thead>\r\n");
      out.write("                            <tbody>\r\n");
      out.write("\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctxPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/static/plugin/treegrid/js/jquery.treegrid.js\"></script>\r\n");
      out.write("<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctxPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/static/plugin/treegrid/js/jquery.treegrid.bootstrap3.js\"></script>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("function add() {\r\n");
      out.write("    layer.open({\r\n");
      out.write("        type: 2,\r\n");
      out.write("        title: '<i class=\"fa fa-plus-circle  blue\"></i>&nbsp;添加资源',\r\n");
      ...
      out.write("        content: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctxPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/resource/addPage' //iframe的url\r\n");
      out.write("    });\r\n");
      out.write("}\r\n");
      out.write("function edit(id) {\r\n");
      out.write("\t layer.open({\r\n");
      out.write("\t        type: 2,\r\n");
      out.write("\t        title: '<i class=\"fa fa-pencil  blue\"></i>&nbsp;编辑资源',\r\n");
      out.write("\t        shadeClose: false,\r\n");
      out.write("\t        shade: 0.8,\r\n");
      out.write("\t        maxmin: true,\r\n");
      out.write("\t        area: ['90%', '90%'],\r\n");
      out.write("\t        content: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctxPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/resource/editPage?id='+id //iframe的url\r\n");
      out.write("\t    });\r\n");
      out.write("}\r\n");
      out.write("function view(id) {\r\n");
      out.write("\t layer.open({\r\n");
      out.write("\t        type: 2,\r\n");
      out.write("\t        title: '<i class=\"fa fa-search  blue\"></i>&nbsp;查看资源',\r\n");
      out.write("\t        shadeClose: false,\r\n");
      out.write("\t        shade: 0.8,\r\n");
      out.write("\t        maxmin: true,\r\n");
      out.write("\t        area: ['90%', '90%'],\r\n");
      out.write("\t        content: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctxPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/resource/viewPage?id='+id //iframe的url\r\n");
      out.write("\t    });\r\n");
      out.write("}\r\n");
      out.write("function del(id,name){\r\n");
      out.write("\tlayer.confirm('真的删除【'+name+'】吗？', function(index){\r\n");
      ...
      out.write("\t});\r\n");
      out.write("}\r\n");
      out.write("function dataGrid(){\r\n");
      out.write("\t $.ajax({\r\n");
      out.write("\t        url:basePath+'/resource/getTreeGrid',\r\n");
      out.write("\t        dataType:'json',\r\n");
      out.write("\t        success:function (data) {\r\n");
      out.write("\t            data=eval('('+data+')');\r\n");
      out.write("\t            var html=\"\";\r\n");
      out.write("\t            $('#info tbody').empty();\r\n");
      out.write("\t            $.each(data,function(index,item){\r\n");
      out.write("\t               if(item.pid==0){\r\n");
      out.write("\t                    html+=\"<tr class='treegrid-\"+item.id+\"'>\";\r\n");
      out.write("\t                }else{\r\n");
      out.write("\t                    html+=\"<tr class='treegrid-\"+item.id+\" treegrid-parent-\"+item.pid+\"'>\";\r\n");
      out.write("\t                }\r\n");
      out.write("\t                html+=\"<td>\"+item.name+\"\";\r\n");
      out.write("\t                html+=\"<div class=\\\"pull-right pos-rel dropdown-hover\\\" hidden>\"\r\n");
      out.write("\t                    +\"<button class=\\\"btn btn-minier bigger btn-primary\\\">\"\r\n");
      out.write("\t                    +\"<i class=\\\"ace-icon fa fa-cog icon-only bigger-120\\\"></i></button>\"\r\n");
      out.write("\t                    +\"<ul class=\\\"dropdown-menu dropdown-only-icon dropdown-yellow dropdown-caret dropdown-close dropdown-menu-right\\\" >\"\r\n");
      out.write("\t                    +\"<li><a href=\\\"#\\\" class=\\\"tooltip-success\\\" data-rel=\\\"tooltip\\\" title=\\\"编辑\\\" onclick='edit(\"+item.id+\")'><span class=\\\"green\\\">\"\r\n");
      out.write("\t                    +\"<i class=\\\"ace-icon fa fa-pencil bigger-110\\\"></i></span></a></li>\"\r\n");
      out.write("\t                    +\"<li><a href=\\\"#\\\" class=\\\"tooltip-success\\\" data-rel=\\\"tooltip\\\" title=\\\"查看\\\" onclick='view(\"+item.id+\")'><span class=\\\"blue\\\">\"\r\n");
      out.write("\t                    +\"<i class=\\\"ace-icon fa fa-search bigger-110\\\"></i></span></a></li>\"\r\n");
      out.write("\t                    +\"<li><a href=\\\"#\\\" class=\\\"tooltip-error\\\" data-rel=\\\"tooltip\\\" title=\\\"删除\\\" onclick=\\\"del(\"+item.id+\",'\"+item.name+\"')\\\"><span class=\\\"red\\\"><i class=\\\"ace-icon fa fa-trash-o bigger-110\\\"></i>\"\r\n");
      out.write("\t                    +\"</span></a></li></ul></div>\";\r\n");
      out.write("\r\n");
      out.write("\t                html+=\"</td>\";\r\n");
      out.write("\t                html+=\"<td class='hidden-480'>\"+(item.url==null?\"\":item.url)+\"</td>\";\r\n");
      out.write("\t                html+=\"<td class='hidden-480'>\"+(item.description==null?'':item.description)+\"</td>\";\r\n");
      out.write("\t                html+=\"<td class='hidden-480'>\"+(item.icon==null?'':'<i class=\\\"'+item.icon+'\\\"')+\"</td>\";\r\n");
      out.write("\t                html+=\"<td class='hidden-480'>\"+(item.status==1?'<span class=\\\"label label-success arrowed-in\\\">有效</span>':'<span class=\"label label-inverse arrowed-in\">无效</span>')+\"</td>\";\r\n");
      out.write("\t                html+=\"<td class='hidden-480'>\"+(item.resourceType==0?'菜单':'其他')+\"</td>\";\r\n");
      out.write("\t                html+=\"<td class='hidden-480'>\"+(item.seq==null?\"\":item.seq)+\"</td>\";\r\n");
      out.write("\t                html+=\"</tr>\"\r\n");
      out.write("\t            });\r\n");
      out.write("\t            $('#info tbody').append(html);\r\n");
      out.write("\t            //提示\r\n");
      ...
      out.write("\t                var $parent = $source.closest('td');\r\n");
      ...
      out.write("\t            }\r\n");
      out.write("\t            $('#info').treegrid({\r\n");
      out.write("\t                expanderExpandedClass: 'fa fa-minus-circle purple',\r\n");
      out.write("\t                expanderCollapsedClass: 'fa fa-plus-circle purple'\r\n");
      out.write("\t            });\r\n");
      out.write("\r\n");
      out.write("\t            $('#info tbody tr').hover(function () {\r\n");
      out.write("\t               $(this).find('.pos-rel').show();\r\n");
      out.write("\t            },function(){\r\n");
      out.write("\t                $(this).find('.pos-rel').hide();\r\n");
      out.write("\t            })\r\n");
      out.write("\t        }\r\n");
      out.write("\t    });\r\n");
      out.write("}\r\n");
      ...
      out.write("\r\n");
      out.write("\t//设置菜单激活\r\n");
      out.write("    var href=basePath+\"/resource/index\";\r\n");
