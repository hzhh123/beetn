...
public class GeneratorService {
	...
	// ===================================
	Bean bean = new Bean();
	public static String BEAN_URL = beanLoadProperties.getValue("BEAN_SERVICE_URL");
	...
	public void generateBean(String tableName, List<CodeBeanProperty> codeBeanProperties) throws Exception {
		if (codeBeanProperties != null) {
			...
			fw.write(createCode(beanLoadProperties.getValue("BEAN_TEMPLATE_SERVICE_VM_PATH"), bean, annotation, codeBeanProperties));
	...
	public static void main(String[] args) throws Exception{
		GeneratorService velocityUtil = new GeneratorService();
