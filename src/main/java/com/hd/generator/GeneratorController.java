...
public class GeneratorController {
	...
	Logger log = LoggerFactory.getLogger(GeneratorController.class);
	...
	// ===================================
	Bean bean = new Bean();
	public static String BEAN_URL = beanLoadProperties.getValue("BEAN_CONTROLLER_URL");
	...
	public void generateBean(String tableName, List<CodeBeanProperty> codeBeanProperties) throws Exception {
		if (codeBeanProperties != null) {
			...
			log.info(StringUtil.handleTableName(tableName));
			bean.setBeanUrl(BEAN_URL);
			bean.setWebActionUrl(WEB_BASE);
			bean.setLowerName(StringUtil.handleColumnName(tableName));
			fw.write(createCode(beanLoadProperties.getValue("BEAN_TEMPLATE_CONTROLLER_VM_PATH"), bean, annotation, codeBeanProperties));
	...
	public static void main(String[] args) throws Exception{
		GeneratorController velocityUtil = new GeneratorController();
