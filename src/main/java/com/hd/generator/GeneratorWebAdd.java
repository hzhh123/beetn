 ...
 */
public class GeneratorWebAdd {

	Logger log = LoggerFactory.getLogger(GeneratorWebAdd.class);
	...
	public static String WEB_BASE = beanLoadProperties.getValue("WEB_BASE");//web前端进入的入口地址
	...
	public void generateBean(String tableName, List<CodeBeanProperty> codeBeanProperties) throws Exception {
		if (codeBeanProperties != null) {
			...
			String fileName = path +handleTableNameFirstLower(tableName) + "Add.jsp";
			...
			fw.write(createCode(beanLoadProperties.getValue("BEAN_TEMPLATE_WEB_ADD_URL"), bean, annotation, codeBeanProperties));
	...
	public static void main(String[] args) throws Exception{
		GeneratorWebAdd velocityUtil = new GeneratorWebAdd();
		String tableNames[]={"test"};
		for(String tableName:tableNames){
			List<CodeBeanProperty>codeBeanProperties= com.hd.jdbc.DBUtil.getColumnProperty(tableName);
