 ...
 */
public class GeneratorWebList {

	Logger log = LoggerFactory.getLogger(GeneratorWebList.class);
	...
	public void generateBean(String tableName, List<CodeBeanProperty> codeBeanProperties) throws Exception {
		if (codeBeanProperties != null) {
			...
			String fileName = path +handleTableNameFirstLower(tableName) + "List.jsp";
			...
			fw.write(createCode(beanLoadProperties.getValue("BEAN_TEMPLATE_WEB_LIST_URL"), bean, annotation, codeBeanProperties));
	...
	public static void main(String[] args) throws Exception{
		GeneratorWebList velocityUtil = new GeneratorWebList();
