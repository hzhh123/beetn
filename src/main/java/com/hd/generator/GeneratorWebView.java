 ...
 */
public class GeneratorWebView {

	Logger log = LoggerFactory.getLogger(GeneratorWebView.class);
	...
	public void generateBean(String tableName, List<CodeBeanProperty>codeBeanProperties) throws Exception {
		if (codeBeanProperties != null) {
			...
			String fileName = path +handleTableNameFirstLower(tableName) + "View.jsp";
			...
			fw.write(createCode(beanLoadProperties.getValue("BEAN_TEMPLATE_WEB_VIEW_URL"), bean, annotation, codeBeanProperties));
	...
	public static void main(String[] args) throws Exception{
		GeneratorWebView velocityUtil = new GeneratorWebView();
