...
public class GeneratorEntity {
	...
	// ===================================
	Bean bean = new Bean();
	public static String BEAN_URL = beanLoadProperties.getValue("BEAN_URL");
	...
	public void generateBean(String tableName, List<CodeBeanProperty> codeBeanProperties) throws Exception {
		if (codeBeanProperties != null) {
			...
			fw.write(createCode(beanLoadProperties.getValue("BEAN_TEMPLATE_VM_PATH"), bean, annotation, codeBeanProperties));
	...
	public static void main(String[] args) throws Exception{
		...
		String tableName="attachfile";
		//DBUtil.deleteColumn(tableName);//删除表映射在code_bean_property中列的属性
		//同步表
