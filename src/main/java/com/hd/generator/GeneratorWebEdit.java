 ...
 */
public class GeneratorWebEdit {

	Logger log = LoggerFactory.getLogger(GeneratorWebEdit.class);
	...
	public void generateBean(String tableName, List<CodeBeanProperty> codeBeanProperties) throws Exception {
		if (codeBeanProperties != null) {
			...
			String fileName = path +handleTableNameFirstLower(tableName) + "Edit.jsp";
			...
			fw.write(createCode(beanLoadProperties.getValue("BEAN_TEMPLATE_WEB_EDIT_URL"), bean, annotation, codeBeanProperties));
	...
	public static void main(String[] args) throws Exception{
		GeneratorWebEdit velocityUtil = new GeneratorWebEdit();
