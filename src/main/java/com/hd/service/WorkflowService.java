...
import com.hd.util.WorkflowUtils;
...
public class WorkflowService {
    protected Logger logger = LogManager.getLogger(WorkflowService.class.getName());
...
//    }
    ...
    private void setCurrentTaskAssignee(Map<String, Object> vars, Task currentTask) throws NumberFormatException, Exception {
        ...
        if (assignee != null) {
        	User assigneeUser = this.userService.getUser(Long.valueOf(assignee));
