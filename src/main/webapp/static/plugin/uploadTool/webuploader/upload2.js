    ...
    $(function() {
        ...
        if ( !WebUploader.Uploader.support('flash') && WebUploader.browser.ie ) {
            ...
            if (flashVersion) {
                (function(container) {
                    ...
                    var swf = 'uploadTool/webuploader/Uploader.swf';
                    // insert flash object
        ...
        uploader = WebUploader.create({
           ...
           chunkSize: 512 * 1024,// 默认大小为5M
            server: BASE_URL+'/test-sync/sync',//接收图片的服务器，或者Controller。【把图片成功保存到一个位置】
            //runtimeOrder: 'flash',
            //只允许上传图片，可选
//             accept: {
//                 title: 'Images',
