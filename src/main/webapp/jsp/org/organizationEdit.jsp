    ...
    <input type="hidden" name="id" value="${organization.id}">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" id="name" value="${organization.name}" lay-verify="required"  autocomplete="off" placeholder="请输入" class="layui-input" >
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">组织机构码<span style="color: red;">*</span> </label>
            <div class="layui-input-block">
                <input type="text" name="number"  lay-verify="required" value="${organization.number}"  autocomplete="off" placeholder="请输入" class="layui-input" >
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">父机构</label>
            <div class="layui-input-block">
                <input type="text" name="parentName"  autocomplete="off" placeholder="请选择" class="layui-input" id="orgName" value="${organization.parentName}">
                <input type="hidden" name="pid" id="orgid" value="${organization.pid}">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">描述</label>
            <div class="layui-input-block">
            <textarea placeholder="请输入内容" name="description" class="layui-textarea">${organization.description}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
